...
exports.openDatabase = function(file) {
		...
		exports.getCmdqueue = function() { return cmdqueue };
		exports.getCurcmd = function() { return curcmd };
		exports.kickstart = function() { curcmd = null; next(); };
		...
		return {
				...
				exec: function() { this.query.apply(this, arguments) },
